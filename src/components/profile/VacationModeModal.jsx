...
export default function VacationModeModal({ open, onClose, profile, onChanged }) {
  ...
  const onActivate = async () => {
    ...
    setSaving(true);
    try {
      const { data, error } = await supabase.rpc('set_streak_freeze', { p_start: start, p_end: end });
      if (error) { setErr(error.message || 'Could not set vacation mode.'); return; }
  ...
  const onCancel = async () => {
    ...
    try {
      ...
      if (error) { setErr(error.message || 'Could not cancel vacation mode.'); return; }
  ...
  return (
    <Modal open={open} onClose={onClose} title="Vacation mode" size="sm">
      <div className="vacation-modal-body">
        <p className="vacation-modal-desc muted">
        ...
        {isActive ? (
          <div className="vacation-mode-active">
            ...
            <div className="vacation-modal-actions">
              ...
              <button type="button" className="btn btn-warning" onClick={onCancel} disabled={saving}>
          ...
          <div className="vacation-mode-form">
            ...
            <div className="vacation-modal-actions">
              ...
              <button type="button" className="btn btn-primary" onClick={onActivate} disabled={saving}>
